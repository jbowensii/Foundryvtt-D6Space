export default class od6sCustomLabelsConfiguration extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        options.title = game.i18n.localize("OD6S.CONFIG_CUSTOM_LABELS");
    ...
    getData() {
        ...
        data.settings = Array.from(game.settings.settings).filter(s => s[1].od6sLabel).map(i => i[1])
