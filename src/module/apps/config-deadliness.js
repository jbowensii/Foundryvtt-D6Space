...
export default class od6sDeadlinessConfiguration extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static DEFAULT_OPTIONS = {
        ...
        window: {
            title: "OD6S.CONFIG_DEADLINESS_MENU",
            resizable: true,
            contentClasses: ["standard-form"]
        },
        form: {
            handler: od6sDeadlinessConfiguration.#onSubmit,
            submitOnChange: true,
            closeOnSubmit: false,
        },
        actions: {
            submit: od6sDeadlinessConfiguration.#onClose
        }
    };
