export default class od6sDeadlinessConfiguration extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        options.title = game.i18n.localize("OD6S.CONFIG_DEADLINESS_MENU");
    ...
    getData() {
        ...
        data.type = 'deadliness';
        data.settings = Array.from(game.settings.settings).filter(s => s[1].od6sDeadliness).map(i => i[1])
