export default class od6sRulesConfiguration extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        options.title = game.i18n.localize("OD6S.CONFIG_RULES_OPTIONS_MENU");
    ...
    getData() {
        ...
        data.settings = Array.from(game.settings.settings).filter(s => s[1].od6sRules).map(i => i[1])
