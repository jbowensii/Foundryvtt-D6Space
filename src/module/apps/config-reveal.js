export default class od6sRevealConfiguration extends FormApplication {
    ...
    static get defaultOptions() {
        ...
        options.title = game.i18n.localize("OD6S.CONFIG_REVEAL_MENU");
    ...
    getData() {
        ...
        data.settings = Array.from(game.settings.settings).filter(s => s[1].od6sReveal).map(i => i[1])
